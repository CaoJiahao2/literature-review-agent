...
User-facing docs in English: [`README.en.md`](../README.en.md)
中文用户文档：[`README.md`](../README.md)

Developer / Architecture docs (中文):
...
> If you spot something that isn't documented or is out of date, please open an
> issue — that is itself a contribution.
